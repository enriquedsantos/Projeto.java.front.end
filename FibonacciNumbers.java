...
public class FibonacciNumbers extends JFrame 
{
   ...
   private final JButton nextNumberJButton = new JButton("Previous Number");
   private final JButton previusJButton = new JButton("Next Number");
   ...
   public FibonacciNumbers()
   {
      ...
      previusJButton.addActionListener(
         new ActionListener()
         {
            public void actionPerformed(ActionEvent event)
            {
      ...
      eventThreadJPanel.add(previusJButton);
